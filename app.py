...
#load Model 
model = load_model('D:\Download\BitCoin_Price_Prediction (1)\Bitcoin_Price_prediction_Model.keras')

st.header('Bitcoin Price Prediction Model')
st.subheader('Bitcoin Price Data')
data = pd.DataFrame(yf.download('BTC-USD','2015-01-01','2024-04-30'))
